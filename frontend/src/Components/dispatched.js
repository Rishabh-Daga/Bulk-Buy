...
const styles = theme => ({
  ...
  class VendorDispatchedView extends Component{
    static propTypes = {
    ...
    fetchProducts = async() => {
        ...
        console.log('fsjfsljfsl')
        var post = axios.post('http://localhost:4000/dispatchedProducts', product)
        .then(res => {
  ...
  export default withCookies(withStyles(styles)(VendorDispatchedView));